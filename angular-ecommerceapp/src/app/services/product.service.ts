...
export class ProductService {
  ...
  getListPaginated(id: number, page: number, size: number): Observable<GetResponseProducts> {
    return this.httpClient.get<GetResponseProducts>(`http://localhost:8080/api/products?category_id=${id}&page=${page}&size=${size}`)
  }
}
